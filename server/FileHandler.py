...
def GEThandler(request):
    ...
    curDate = convertTime(time.gmtime())
    ...
    try:
        ...
        print(f"SUCCESS: {curDate}: '{request[0]} {request[1]}'")
        return final_response

    except Exception as e:
        print( f"WARNING: {curDate}, '{request[0]} {request[1]}' {e.args}.")
